...
import examples.ZSChain.blocks.{PosBlock, PowBlock}
...
class HLocalInterface(viewHolderRef: ActorRef,
  ...
  import examples.ZSChain.mining.PosForger.ReceivableMessages.{StartForging, StopForging}
  import examples.ZSChain.mining.PowMiner.ReceivableMessages.{MineBlock, StartMining, StopMining}
